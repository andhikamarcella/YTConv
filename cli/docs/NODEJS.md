...
The npm CLI needs Node.js 22.14.0+ and npm 10+. Node 24 LTS is recommended for YTConv 1.7.7. Official downloads are available from [nodejs.org](https://nodejs.org/en/download).
...
node.exe --version
npm.cmd --version
npm.cmd install -g ytconv@1.7.7
ytconv.cmd doctor
```
...
npm install -g ytconv@1.7.7 --omit=optional
ytconv repair
ytconv doctor
```
