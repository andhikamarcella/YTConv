...
The release may also provide an EXE installer and portable ZIP. Verify SHA256SUMS-windows.txt from the matching ytconv-v1.7.7 release before running downloaded binaries.
