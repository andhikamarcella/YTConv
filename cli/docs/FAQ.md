...
The repository default branch hosts the web application, while the maintained CLI lives on versioned release branches. YTConv 1.7.7 restores a compatibility docs path on the default branch and prints release-pinned documentation URLs through `ytconv docs`.
