#!/usr/bin/env python3
"""Deterministic YTConv iSH and Alpine 1.7.7 behavior checks."""
...
class ReleaseIdentityTests(unittest.TestCase):
    def test_wrapper_version_branch_and_remote_version_are_synchronized(self):
        self.assertEqual(WRAPPER.VERSION, "1.7.7")
        self.assertEqual(WRAPPER.RELEASE_BRANCH, "release/ytconv-1.7.7")
        self.assertIn("release/ytconv-1.7.7", WRAPPER.RAW_BASE)
        self.assertEqual((ROOT / "ish" / "VERSION").read_text(encoding="utf-8").strip(), "1.7.7")
