...
node_supported || fail "Node.js $(node --version) is unsupported. Install Node.js 22.14+ or use a native 1.7.7 package."
...
say "Native DEB, RPM, Arch, Alpine APK, AppImage, Snap, Flatpak, and Nix artifacts are available in the 1.7.7 GitHub release."
