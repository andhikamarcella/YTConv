...
test('package publishes recognized license types and no lifecycle install hooks', () => {
...
test('README exposes versioned Socket TypeScript ISC and security documentation', () => {
  assert.match(readme, new RegExp(`badge\\.socket\\.dev/npm/package/ytconv/${manifest.version.replaceAll('.', '\\.')}`, 'u'));
