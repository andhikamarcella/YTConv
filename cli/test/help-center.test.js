...
test('help-center panels are responsive and discoverable', () => {
  assert.match(aboutText(50), /YTConv 1\.7\.6/u);
  ...
  assert.match(migrationText, /https:\/\/github\.com\/andhikamarcella\/YTConv\/blob\/release\/ytconv-1\.7\.6\/cli\/docs\/MIGRATION-1\.7\.6\.md/u);
