#!/usr/bin/env python3
"""YTConv 1.7.7 native frontend for iSH/Alpine and Python-only shells."""
...
VERSION = "1.7.7"
RAW_BASE = "https://raw.githubusercontent.com/andhikamarcella/YTConv/release/ytconv-1.7.7/cli"
